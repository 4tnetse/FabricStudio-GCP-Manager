...
- **Docker:** open [http://localhost:8080/manual/configuration/](http://localhost:8080/manual/configuration/)
- **From source:** open [http://localhost:1980/manual/configuration/](http://localhost:1980/manual/configuration/)
