...
| **Workshop name** | Yes | Base name for the cloned instances. Auto-filled from the source instance name. |
| **Customer, Partner or Event** | No | Applied as a `purpose` label on all cloned instances (e.g. `fortinet-workshop`) |
